...
public class Optimiser extends MachineBase implements ITileEntityProvider {

    public static final PropertyDirection FACING = PropertyDirection.create("facing");

    public Optimiser() {
        super(Material.IRON, "optimiser");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
        ...
        playerIn.openGui(EmergingTechnology.instance, Reference.GUI_OPTIMISER, worldIn, pos.getX(), pos.getY(),
                pos.getZ());
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new OptimiserTileEntity();
    }
