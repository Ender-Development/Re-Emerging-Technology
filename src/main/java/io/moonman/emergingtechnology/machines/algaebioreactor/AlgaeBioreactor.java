...
public class AlgaeBioreactor extends MachineBase implements ITileEntityProvider {

    public static final PropertyDirection FACING = PropertyDirection.create("facing");

    public AlgaeBioreactor() {
        super(Material.IRON, "algaebioreactor");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
        ...
        playerIn.openGui(EmergingTechnology.instance, Reference.GUI_ALGAEBIOREACTOR, worldIn, pos.getX(), pos.getY(),
                pos.getZ());
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new AlgaeBioreactorTileEntity();
    }
