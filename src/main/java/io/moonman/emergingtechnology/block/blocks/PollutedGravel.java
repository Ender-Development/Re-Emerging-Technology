...
public class PollutedGravel extends Block {

    private final String _name = "pollutedgravel";

    public PollutedGravel() {
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        items.add(new ItemStack(ModItems.plasticwaste));
        items.add(new ItemStack(Blocks.GRAVEL));
