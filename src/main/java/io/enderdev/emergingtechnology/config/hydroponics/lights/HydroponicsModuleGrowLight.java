package io.enderdev.emergingtechnology.config.hydroponics.lights;

import io.enderdev.emergingtechnology.config.hydroponics.lights.boosts.IdealGrowthBoost;
