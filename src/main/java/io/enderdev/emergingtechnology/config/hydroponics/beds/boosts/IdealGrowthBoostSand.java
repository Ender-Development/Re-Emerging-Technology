package io.enderdev.emergingtechnology.config.hydroponics.beds.boosts;

import io.enderdev.emergingtechnology.config.hydroponics.enums.CropTypeEnum;
import io.enderdev.emergingtechnology.config.hydroponics.interfaces.IIdealBoostsConfiguration;
import net.minecraftforge.common.config.Config;
import net.minecraftforge.common.config.Config.Name;
import net.minecraftforge.common.config.Config.RangeInt;

public class IdealGrowthBoostSand implements IIdealBoostsConfiguration {
    ...
    @RangeInt(min = 0, max = Integer.MAX_VALUE)
    public int sugarcaneAddedProbability = 10;
