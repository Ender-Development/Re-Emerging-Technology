...
class BlockProcessor() : RotatableMachineBlock("processor", EmergingTechnology.guiHandler.registerId(TileProcessor::class.java, ContainerProcessor::class.java) { GuiProcessor::class.java }) {
	init {
		blockHardness = 1f
	}
