...
class TileTissueScaffolder : BaseMachineTile<TissueScaffolderRecipe>(EmergingTechnology), IEnergyTile by EnergyTileImpl(10000), IOptimisableTile by OptimisableTileImpl() {
	init {
